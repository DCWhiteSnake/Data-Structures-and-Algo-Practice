class CreditCard:
    ...
    def __init__(self, customer, bank, acnt, limit, initialbalance = 100):
        ...
        initialbalance      the optional initial balance stored in the account
        """ 
